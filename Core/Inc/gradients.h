 ...
 * 
 * This file contains the functions for managing the color gradients.
 * 
 * Credit to WLED/wled00 repository for the gradient palettes.
 *
 ***/
...
// by name every time.
const uint8_t* const gradient_palettes_list[] = {
...
const uint8_t gradient_palettes_list_size = sizeof(gradient_palettes_list)/sizeof(uint8_t *);
const char *gradient_palette_name_list[] = { 
